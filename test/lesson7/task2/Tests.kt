...
class Tests {
    ...
    fun generateSnake() {
        ...
        assertEquals(createMatrix(9, 8,
                listOf(
                        listOf(1, 2, 4, 7, 11, 16, 22, 29, 37),
                        listOf(3, 5, 8, 12, 17, 23, 30, 38, 45),
                        listOf(6, 9, 13, 18, 24, 31, 39, 46, 52),
                        listOf(10, 14, 19, 25, 32, 40, 47, 53, 58),
                        listOf(15, 20, 26, 33, 41, 48, 54, 59, 63),
                        listOf(21, 27, 34, 42, 49, 55, 60, 64, 67),
                        listOf(28, 35, 43, 50, 56, 61, 65, 68, 70),
                        listOf(36, 44, 51, 57, 62, 66, 69, 71, 72)
                )), generateSnake(9, 8))
